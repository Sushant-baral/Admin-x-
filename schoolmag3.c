...
void viewData() {
    ...
    if (choice == 1) {
        ...
        while (fread(&m, sizeof(m), 1, f)) {
            ...
            printf("Year 1 GPA: %s", m.year1 == -1.0 ? "Not Yet\n" : "");
            if (m.year1 != -1.0) printf("%.2f\n", m.year1);

            printf("Year 2 GPA: %s", m.year2 == -1.0 ? "Not Yet\n" : "");
            if (m.year2 != -1.0) printf("%.2f\n", m.year2);

            printf("Year 3 GPA: %s", m.year3 == -1.0 ? "Not Yet\n" : "");
            if (m.year3 != -1.0) printf("%.2f\n", m.year3);

            printf("Year 4 GPA: %s", m.year4 == -1.0 ? "Not Yet\n" : "");
            if (m.year4 != -1.0) printf("%.2f\n", m.year4);
...
void schoolMenu() {
    ...
    do {
        ...
        if (ch == 1) {
            ...
            printf("✅ Welcome to Staff Management! (Coming soon...)\n");
        } else if (ch == 3) {
            break;
        } else {
            printf("❌ Invalid choice.\n");
